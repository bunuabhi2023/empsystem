...
class EventController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-event'))
		{
			...
			return view('event and meeting.event.index', compact('client_groups'));
		}
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('event_title', 'client_grp_id', 'location_id', 'sub_location_id', 'company_id', 'department_id', 'event_note', 'event_date', 'event_time',
				'status', 'is_notify'
			),
				[
