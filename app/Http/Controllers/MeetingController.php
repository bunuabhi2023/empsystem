...
class MeetingController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-meeting'))
		{
			...
			return view('event and meeting.meeting.index', compact('client_groups'));
		}
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('meeting_title', 'client_grp_id', 'location_id', 'sub_location_id', 'company_id', 'employee_id', 'meeting_note', 'meeting_date', 'meeting_time',
				'status', 'is_notify'
			),
				[
