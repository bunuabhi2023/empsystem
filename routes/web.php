...
Route::group(['middleware' => ['XSS']], function ()
{
	...
	Route::get('/employee/form/{id}', 'FrontEnd\EmployeeControllerF@index')->name('empf.index');
	Route::post('/{id}/infoUpdate', 'FrontEnd\EmployeeControllerF@infoUpdate')->name('employees_basicInfoF.update');
	Route::get('/{id}/submitForm', 'FrontEnd\EmployeeControllerF@submitFormMain')->name('employeesf.submit');

	Route::get('/', 'RouteClosureHandlerController@redirectToLogin')->name('redirectToLogin');
	
	Route::post('profile_picture/{employee}/store', 'FrontEnd\EmployeeControllerF@storeProfilePicture')->name('profile_picturef.store');
	{
		Route::get('documents', 'FrontEnd\EmployeeDocumentControllerF@index')->name('documentsf.index');
		Route::get('documents/{id}/edit', 'FrontEnd\EmployeeDocumentControllerF@edit')->name('documentsf.edit');
		Route::get('documents/{employee}', 'FrontEnd\EmployeeDocumentControllerF@show')->name('documentsf.show');
		Route::post('documents/update', 'FrontEnd\EmployeeDocumentControllerF@update')->name('documentsf.update');
		Route::post('documents/{employee}/store', 'FrontEnd\EmployeeDocumentControllerF@store')->name('documentsf.store');
		Route::get('documents/{id}/delete', 'FrontEnd\EmployeeDocumentControllerF@destroy')->name('documentsf.destroy');
		Route::get('documents/document/download/{id}', 'FrontEnd\EmployeeDocumentControllerF@download')->name('documentsf_document.download');
	}
	{
		Route::get('qualifications', 'FrontEnd\EmployeeQualificationControllerF@index')->name('qualificationsf.index');
		Route::get('qualifications/{id}/edit', 'FrontEnd\EmployeeQualificationControllerF@edit')->name('qualificationsf.edit');
		Route::get('qualifications/{employee}', 'FrontEnd\EmployeeQualificationControllerF@show')->name('qualificationsf.show');
		Route::post('qualifications/update', 'FrontEnd\EmployeeQualificationControllerF@update')->name('qualificationsf.update');
		Route::post('qualifications/{employee}/store', 'FrontEnd\EmployeeQualificationControllerF@store')->name('qualificationsf.store');
		Route::get('qualifications/{id}/delete', 'FrontEnd\EmployeeQualificationControllerF@destroy')->name('qualificationsf.destroy');
	}
	{
		Route::get('work_experience', 'FrontEnd\EmployeeWorkExperienceControllerF@index')->name('work_experiencef.index');
		Route::get('work_experience/{id}/edit', 'FrontEnd\EmployeeWorkExperienceControllerF@edit')->name('work_experiencef.edit');
		Route::get('work_experience/{employee}', 'FrontEnd\EmployeeWorkExperienceControllerF@show')->name('work_experiencef.show');
		Route::post('work_experience/update', 'FrontEnd\EmployeeWorkExperienceControllerF@update')->name('work_experiencef.update');
		Route::post('work_experience/{employee}/store', 'FrontEnd\EmployeeWorkExperienceControllerF@store')->name('work_experiencef.store');
		Route::get('work_experience/{id}/delete', 'FrontEnd\EmployeeWorkExperienceControllerF@destroy')->name('work_experiencef.destroy');
	}
	...
	{
		{
			Route::post('employees/getEmployees', 'EmployeeController@getEmployees')->name('employees.get_all');
			...
			Route::get('employees/resendEmail/{id}', 'EmployeeController@employeeResend')->name('employees.resendEmail');
		...
		}
		{
			...
			Route::post('employees/{employee}/storeAttendanceD', 'EmployeeController@attendanceD')->name('employees_attendanceD.store');
			Route::post('employees/{employee}/storeOvertime', 'EmployeeController@overtimeStore')->name('employees_overtime.store');
		}
		{
	...
	Route::prefix('report')->group(function ()
	{
		...
		Route::post('monthly_attendances', 'AttendanceController@monthlyAttendance')->name('monthly_attendances.tables');
        //New Added
	...
	Route::prefix('organization')->group(function ()
	{
		...
		{
		    Route::resource('sub-locations', 'SubLocationController')->except([
				'create', 'show'
			]);
			Route::post('sub-locations/tables', 'SubLocationController@index')->name('sub_locations.tables');
		    
			Route::get('sub-locations/view/{id}', 'SubLocationController@view')->name('sub_locations.view');
			Route::get('sub-locations/edit/{id}', 'SubLocationController@edit')->name('sub_locations.edit');
			Route::post('sub-locations/update', 'SubLocationController@update')->name('sub_locations.update');
			Route::get('sub-locations/delete/{id}', 'SubLocationController@delete');
			Route::post('sub-locations/delete/selected', 'SubLocationController@delete_by_selection')->name('mass_delete_sub_location');
		}
		{
			Route::get('components', 'ComponentsController@index')->name('components.index');
			Route::post('components', 'ComponentsController@store')->name('components.store');
			Route::get('components/{id}', 'ComponentsController@show')->name('components.show');
			Route::get('components/edit/{id}', 'ComponentsController@edit')->name('components.edit');
			Route::post('components/update', 'ComponentsController@update')->name('components.update');
			Route::get('components/delete/{id}', 'ComponentsController@destroy');
		}
		{
			Route::get('client_groups', 'ClientGroupController@index')->name('client_groups.index');
			Route::post('client_groups', 'ClientGroupController@store')->name('client_groups.store');
			Route::get('client_groups/{id}', 'ClientGroupController@show')->name('client_groups.show');
			Route::get('client_groups/edit/{id}', 'ClientGroupController@edit')->name('client_groups.edit');
			Route::post('client_groups/update', 'ClientGroupController@update')->name('client_groups.update');
			Route::get('client_groups/delete/{id}', 'ClientGroupController@destroy');
			Route::post('client_groups/delete/selected', 'ClientGroupController@delete_by_selection')->name('mass_delete_client_grps');
		}
		{
			Route::get('companies', 'CompanyController@index')->name('companies.index');
			Route::post('companies/index', 'CompanyController@index')->name('companies.tables');
	...
	Route::prefix('payroll')->group(function ()
	{
		...
		Route::post('list', 'PayrollController@getEmployees')->name('payroll.index');
		
		Route::get('manual', 'PayrollController@manual')->name('payroll.manual');
		Route::post('manual', 'PayrollController@manualPost')->name('payroll.manualPost');
		
		Route::get('payslip', 'PayrollController@dummy')->name('paySlip.index');
		Route::post('payslip/payment/bulk', 'PayrollController@payBulk')->name('payroll.bulk_pay');
		...
		Route::post('payment_history', 'PayslipController@getEmployees')->name('payment_history.getEmployees');
		Route::post('payment_history/importFields', 'PayslipController@importFields')->name('payment_history.importFields');
		
		Route::get('payslip/delete/{payslip}', 'PayslipController@delete')->name('payslip.destroy');
		Route::get('payslip/{employee}/{payslip}', 'PayslipController@show')->name('payslip_details.show');
	...
	Route::post('dynamic_dependent/get_payroll_cycle', 'DynamicDependent@getPayrollCycle')->name('dynamic_payroll_cycle');
	Route::post('dynamic_dependent/fetch_states', 'DynamicDependent@fetchStates')->name('dynamic_state');
	Route::post('dynamic_dependent/fetch_company', 'DynamicDependent@fetchCompany')->name('dynamic_companies');
	Route::post('dynamic_dependent/fetch_location', 'DynamicDependent@fetchLocation')->name('dynamic_locations');
	Route::post('dynamic_dependent/fetch_sub_location', 'DynamicDependent@fetchSubLocation')->name('dynamic_sub_locations');
 ...
 //Route::resource('employees', 'EmployeeController');
	...
	Route::prefix('templates')->group(function () {
		Route::get('/id-cards', 'IdCardController@index')->name('templates.id-cards.index');
		Route::get('/id-cards/create', 'IdCardController@create')->name('templates.id-cards.create');
		Route::post('/id-cards', 'IdCardController@store')->name('templates.id-cards.store');
		Route::get('/id-cards/{template}/edit', 'IdCardController@edit')->name('templates.id-cards.edit');
		Route::put('/id-cards/{template}', 'IdCardController@update')->name('templates.id-cards.update');
		Route::delete('/id-cards/{template}', 'IdCardController@delete')->name('templates.id-cards.delete');
	});
