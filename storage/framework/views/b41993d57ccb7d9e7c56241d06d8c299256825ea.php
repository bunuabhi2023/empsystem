...
<head>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/webcam.js')); ?>"></script>
        ...
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                <?php if(Auth::user()->role_users_id==1): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('https://wa.me/919990095122')); ?>" target="_blank" data-toggle="tooltip"
                           title="<?php echo e(__('Whatsapp')); ?>">
    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-details-employee')): ?>
                    <li class="has-dropdown <?php echo e((request()->is('staff*')) ? 'active' : ''); ?>">
                        ...
                        <ul id="employees" class="collapse list-unstyled ">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-details-employee')): ?>
                                <li id="employee_list"><a href="<?php echo e(route('employees.index')); ?>"><?php echo e(__('Add/Update Employee')); ?></a></li>
                            <?php endif; ?>
                    ...
                    <ul id="Organization" class="collapse list-unstyled ">
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-client-group')): ?>
                                <li id="client_group"><a href="<?php echo e(route('client_groups.index')); ?>"><?php echo e(trans('Client Group')); ?></a></li>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-sub-location')): ?>
                            <li id="sub-location"><a href="<?php echo e(route('sub-locations.index')); ?>">Sub Location</a></li>
                        <?php endif; ?>
                ...
                <li class="has-dropdown <?php echo e((request()->is('templates*')) ? 'active' : ''); ?>"><a href="#Template_Settings" aria-expanded="false" data-toggle="collapse">
                        <i class="dripicons dripicons-device-desktop"></i><span><?php echo e(__('Template Settings')); ?></span></a>
                    <ul id="Template_Settings" class="collapse list-unstyled ">
                        
                    <li id="id_template"><a href="<?php echo e(route('templates.id-cards.index')); ?>"><?php echo e(__('ID Template')); ?></a></li>


                       
                            <li id="offre_template"><a href=""><?php echo e(__('Offer Letter Template')); ?></a></li>
                    ...
                    <li class="has-dropdown <?php echo e((request()->is('payroll*')) ? 'active' : ''); ?>">
                        ...
                        <?php if(auth()->user()->can('view-payslip') || auth()->user()->can('view-paylist')): ?>
                            <a href="#Payroll" aria-expanded="false" data-toggle="collapse">
                                <i class="dripicons-wallet"></i><span><?php echo e(trans('file.Payment')); ?></span>
                            </a>
                        <?php endif; ?>

                        <ul id="Payroll" class="collapse list-unstyled ">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-payslip')): ?>
                                <li><a href="<?php echo e(route('payroll.index')); ?>"><?php echo e(__('Generate Payment')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-payslip')): ?>
                                <li><a href="<?php echo e(route('payroll.manual')); ?>"><?php echo e(__('Generate Manual Payment')); ?></a>
                                </li>
                            <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customize-setting')): ?>
                    <li class="has-dropdown <?php echo e((request()->is('settings*')) ? 'active' : ''); ?>">
                        <?php if(auth()->user()->can('view-role')||auth()->user()->can('view-general-setting')||auth()->user()->can('access-language')||auth()->user()->can('access-variable_type')||auth()->user()->can('access-variable_method')||auth()->user()->can('view-general-setting')): ?>
                            <a href="#manageDropdowns" aria-expanded="false" data-toggle="collapse">
                                <i class="dripicons-toggles"></i><span><?php echo e(__('Manage Dropdowns')); ?></span>
                            </a>
                        <?php endif; ?>
                        

                        <ul id="manageDropdowns" class="collapse list-unstyled ">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-general-setting')): ?>
                                <li id="states_settings"><a
                                            href="<?php echo e(route('states.index')); ?>"><?php echo e(__('Add/Update States')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-variable_type')): ?>
                                <li id="variable_type"><a
                                            href="<?php echo e(route('variables.index')); ?>"><?php echo e(__('Add/Update Variable Types')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-variable_method')): ?>
                                <li id="variable_method"><a
                                            href="<?php echo e(route('variables_method.index')); ?>"><?php echo e(__('Add/Update Variable Methods')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-department')): ?>
                                <li id="department"><a
                                            href="<?php echo e(route('departments.index')); ?>"><?php echo e(trans('Add/Update Department')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-designation')): ?>
                                <li id="designation"><a
                                            href="<?php echo e(route('designations.index')); ?>"><?php echo e(trans('Add/Update Designation')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-office_shift')): ?>
                                <li id="office_shift"><a
                                            href="<?php echo e(route('office_shift.index')); ?>"><?php echo e(__('Add/Update Office Shift')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-variable_type')): ?>
                                <li id="salary_components"><a
                                            href="<?php echo e(route('components.index')); ?>"><?php echo e(__('Add/Update Salary Components')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-holiday')): ?>
                                <li id="holiday"><a href="<?php echo e(route('holidays.index')); ?>"><?php echo e(__('Add/Update Holiday')); ?></a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-leave')): ?>
                                <li id="leave"><a href="<?php echo e(route('leaves.index')); ?>"><?php echo e(__('Add/Update Leaves')); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                <?php endif; ?>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            <p>&copy; <?php echo e($general_settings->site_title ?? "no title"); ?> | <?php echo e(__('Developed by')); ?> <a
                        href=<?php echo e($general_settings->footer_link); ?> class="external"><?php echo e($general_settings->footer); ?></a>|| Version - <?php echo e(env('VERSION')); ?></p></p>
        </div>
    </footer>
</div>
...
<?php /**PATH D:\app\resources\views/layout/main.blade.php ENDPATH**/ ?>