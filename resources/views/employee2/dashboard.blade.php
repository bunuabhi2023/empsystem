            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <h2>{{$employee->first_name ." - ". $employee->staff_id}}</h2>
                    </div>
                    <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#Profile" role="tab"
                               aria-controls="Profile" aria-selected="false">{{trans('Profile Photo')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="set_salary-tab" data-toggle="tab" href="#Set_salary" role="tab"
                               aria-controls="Set_salary" aria-selected="false">{{__('Set Payroll')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="leaves-tab" data-toggle="tab" href="#Leaves" role="tab"
                               aria-controls="Leave" aria-selected="false">{{trans('Leave Settings')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="leave-tab" data-toggle="tab" href="#Leave" role="tab"
                               aria-controls="Leave" aria-selected="false">{{trans('Leaves Applied')}}</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('Full Name As per Aadhar')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('Aadhar Number')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('PAN')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('UAN')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('PF Number')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('ESIC Number')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('Employee Id')}} <span class="text-danger">*</span></label>
                                                        <input type="text" name="staff_id" id="staff_id" readonly
                                                               placeholder="Auto Generate On Approval"
                                                               class="form-control" required
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{trans('Official Email')}} <span class="text-danger">*</span></label>
                                                        <input type="text" name="off_email" id="off_email"
                                                               placeholder="{{trans('Official Email')}}"
                                                               class="form-control" required
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{trans('Alternate Phone')}} </label>
                                                        <input type="text" name="alt_phone" id="alt_phone"
                                                               placeholder="{{trans('Alternate Phone')}}"
                                                                class="form-control"
                                                               value="{{ $employee->alt_phone }}">
                                                    </div>

                                                    <div class="col-md-4 form-group">
                                                        <label>{{trans('Address Line 1')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="city" id="city"
                                                               placeholder="{{trans('file.City')}}" required
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <label>{{trans('file.State/Province')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="zip_code" id="zip_code"
                                                               placeholder="{{trans('file.ZIP')}}" required
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="date_of_birth" id="date_of_birth"
                                                               required autocomplete="off" class="form-control date" required
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('Disability')}} <span class="text-danger">*</span></label>
                                                        <input type="hidden" name="disability_hidden"
                                                               value="{{ $employee->disability }}"/>
                                                        <select name="disability" id="disability"
                                                                class="selectpicker form-control"
                                                                data-live-search="true"
                                                                data-live-search-style="contains" required
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="client_grp_id_hidden"
                                                               value="{{ $employee->client_grp_id }}"/>
                                                            <select name="client_grp_id" id="client_grp_id"
                                                                    class="form-control selectpicker"
                                                                    data-live-search="true"
                                                                    data-live-search-style="contains"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{trans('Location')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="sub_location_id_hidden"
                                                               value="{{ $employee->sub_location_id }}"/>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{trans('Working Country')}} <span class="text-danger">*</span></label>
                                                            <select name="wcountry" id="wcountry"
                                                                    class="form-control selectpicker"
                                                                    data-live-search="true" required
                                                                    data-live-search-style="contains"
                                                                    title="{{__('Selecting',['key'=>trans('Working Country')])}}...">
                                                                <option readonly></option>
                                                                @foreach($countries as $country)
                                                                    <option value="{{$country->id}}" {{ ($employee->wCountry == $country->id) ? "selected" : '' }}>{{$country->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input type="hidden" name="wstate_hidden"
                                                               value="{{ $employee->wState }}"/>
                                                            <label>{{trans('Working State')}} <span class="text-danger">*</span></label>
                                                            <select name="wstate" id="wstate"
                                                                    class="form-control selectpicker"
                                                                    data-live-search="true" required
                                                                    data-live-search-style="contains"
                                                                    title="{{__('Selecting',['key'=>trans('Working State')])}}...">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{trans('Employment Status')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{trans('Working Shift')}} <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="text-bold">{{__('Attendance Deduction Type')}} <span class="text-danger">*</span></label>
                                                        <select name="employee_type" id="employee_type" required class="selectpicker form-control"
                                                                data-live-search="true" data-live-search-style="contains" title="{{__('Select Attendance Deduction Type...')}}">
                                                                <option value="regular" @if($employee->employee_type=='regular') selected  @endif>{{__('Continuous Deduction')}}</option>
                                                                <option value="other" @if($employee->employee_type=='other') selected  @endif>{{__('Only Leave Deduction')}}</option>
                                                        </select>
                                                    </div>

                                                    <div class="col-md-4">
                                                        <label class="text-bold">{{__('Payable Type')}} <span class="text-danger">*</span></label>
                                                        <select name="payable_type" required id="payable_type" class="selectpicker form-control"
                                                                data-live-search="true" data-live-search-style="contains" title="{{__('Select Payable Type...')}}">
                                                            @foreach($paymentMethods as $paymentMethod)
                                                                <option value="{{$paymentMethod->method_name}}" @if($employee->payable_type==$paymentMethod->method_name) selected  @endif>{{$paymentMethod->method_name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    @if($employee->is_active == '0' || $employee->is_active == '2' && $employee->user->is_active == "0" || $employee->user->is_active == '2')
                                                    <div class="col-md-4">
                                                        <label class="text-bold" for="approval_stat">Approval Status <span class="text-danger">*</span></label>
                                                        <select name="approval_stat" id="approval_stat" class="selectpicker form-control"
                        ...
                        <div class="tab-pane fade" id="Set_salary" role="tabpanel" aria-labelledby="set_salary-tab">
                            ...
                            {{__('Salary Info')}}
                            <hr>
                        @include('employee2.salary.index')
                        ...
                        <div class="tab-pane fade" id="Leaves" role="tabpanel" aria-labelledby="leaves-tab">
                            ...
                            {{__('Leave Settings')}}
                            <hr>
                        @include('employee2.leaves.index')
                        ...
                        <div class="tab-pane fade" id="Employee_Core_hr" role="tabpanel"
                            ...
                            {{__('Core HR')}}
                            <hr>
                        @include('employee2.core_hr.award.index')
                        ...
                        <div class="tab-pane fade" id="Employee_project_task" role="tabpanel"
                            ...
                            <hr>
                        @include('employee2.project_task.index')
                        ...
                        <div class="tab-pane fade" id="Employee_Payslip" role="tabpanel"
                            ...
                            {{trans('file.Payslip')}}
                            <hr>
                        @include('employee2.payslip.index')
...
// 	if($('#role_user_hidden').val() == 2){
// 		$('#company_id').removeAttr("multiple");
// 	}else{
// 		$('#company_id').attr("multiple", "true");
// 		$('#company_id').attr("name", "company_id[]");
// 	}
        
    $('#client_grp_id').selectpicker('val', $('input[name="client_grp_id_hidden"]').val());
    
    var selectedCompanies = JSON.parse($('input[name="company_id_hidden"]').val());
    $('#company_id').selectpicker('val', selectedCompanies);    

    $('#location_id').selectpicker('val', $('input[name="location_id_hidden"]').val());
    $('#sub_location_id').selectpicker('val', $('input[name="sub_location_id_hidden"]').val());
        ...
        if ($('#wcountry').val() != '') {
            ...
            $.ajax({
                ...
                success: function (result) {
                    $('select').selectpicker("destroy");
                    $('#wstate').html(result);
                    $('#wstate').selectpicker("val", $('input[name="wstate_hidden"]').val());
                    $('select').selectpicker();
                }
            });
        }
    ...
    $('[data-table="immigration"]').one('click', function (e) {
            @include('employee2.immigration.index_js')

    });

    $('[data-table="emergency"]').one('click', function (e) {
        @include('employee2.emergency_contacts.index_js')
    });

    $('[data-table="document"]').one('click', function (e) {
            @include('employee2.documents.index_js')
    });

    $('[data-table="qualification"]').one('click', function (e) {
        @include('employee2.qualifications.index_js')
    });

    $('[data-table="work_experience"]').one('click', function (e) {
        @include('employee2.work_experience.index_js')
    });

    $('[data-table="bank_account"]').one('click', function (e) {
        @include('employee2.bank_account.index_js')
    });

    $('#profile-tab').one('click', function (e) {
        @include('employee2.profile_picture.index_js')
    });

    $('#set_salary-tab').one('click', function (e) {
       @include('employee2.salary.basic.index_js') //employee2.salary.index_js.blade.php - both are same
    });

    $('#salary_allowance-tab').one('click', function (e) {
        @include('employee2.salary.allowance.index_js')
    });

    $('#salary_commission-tab').one('click', function (e) {
        @include('employee2.salary.commission.index_js')
    });

    $('#salary_loan-tab').one('click', function (e) {
        @include('employee2.salary.loan.index_js')
    });

    $('#salary_deduction-tab').one('click', function (e) {
        @include('employee2.salary.deduction.index_js')
    });

   $('#other_payment-tab').one('click', function (e) {
        @include('employee2.salary.other_payment.index_js')
    });

    $('#salary_overtime-tab').one('click', function (e) {
        @include('employee2.salary.overtime.index_js')
    });

    $('#salary_pension-tab').one('click', function (e) {
        @include('employee2.salary.pension_amount_js')
    });


    $('#leave-tab').one('click', function (e) {
        @include('employee2.leave.index_js')
    });


    $('#employee_core_hr-tab').one('click', function (e) {
        @include('employee2.core_hr.award.index_js')
    });

    $('#employee_travel-tab').one('click', function (e) {
        @include('employee2.core_hr.travel.index_js')
    });

    $('#employee_training-tab').one('click', function (e) {
        @include('employee2.core_hr.training.index_js')
    });

    $('#employee_ticket-tab').one('click', function (e) {
        @include('employee2.core_hr.ticket.index_js')
    });


    $('#employee_transfer-tab').one('click', function (e) {
        @include('employee2.core_hr.transfer.index_js')
    });


    $('#employee_promotion-tab').one('click', function (e) {
        @include('employee2.core_hr.promotion.index_js')
    });

    $('#employee_complaint-tab').one('click', function (e) {
        @include('employee2.core_hr.complaint.index_js')
    });


    $('#employee_warning-tab').one('click', function (e) {
        @include('employee2.core_hr.warning.index_js')
    });

    $('#employee_project_task-tab').one('click', function (e) {
        @include('employee2.project_task.project.index_js')

    });

    $('#employee_task-tab').one('click', function (e) {
        @include('employee2.project_task.task.index_js')
    });

    $('#employee_payslip-tab').one('click', function (e) {
        @include('employee2.payslip.index_js')
    });
