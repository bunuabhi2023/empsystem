...
@section('content')
    ...
    <section>
        ...
        <div class="card animated fadeInRight mr-5 ml-5">
            ...
            <div class="card-body">
                <h6><a href="{{url('sample_file/sample_employee.csv')}}" class="btn btn-primary"> <i
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <fieldset class="form-group">
                                    <label for="update_data">Choose One File Type:</label>
                                    <select name="update_data" id="update_data" class="form-control form-control-sm">
                                        <option value="0">Add Employees</option>
                                        <option value="1">Update Employees</option>
                                    </select>
                                </fieldset>
                            </div>
                        </div>
                    ...
                    <div class="mt-1">
                        <div class="form-actions box-footer">
                            <button name="import_form" type="submit" class="btn btn-primary"><i
                                        class="fa fa fa-check-square-o"></i> {{trans('file.Upload')}}
                            </button>
                        </div>
                    </div>
                </form>
