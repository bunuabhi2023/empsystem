                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 d-flex" style="flex-direction: column;justify-content: center">
                                <div class="form-check">
                                    <input type="checkbox" name="common_des" id="common_des" class="form-check-input" value="1">
                                    <label class="form-check-label" for="common_des">
                                        Common For All Companies?
                                    </label>
                                </div>
                                <small>Note: If this is checked then you don't have to select any company!</small>
                            </div>
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    $('#department_id').selectpicker('refresh');
                    if(html.data.is_common == 1){
                        $('#common_des').attr("checked", "true");
                    }
