        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    $('#client_grp_id').selectpicker('val', html.data.company_id);
                            ...
                            success: function (result) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        ...
                                        $('#location_id').selectpicker('val', html.data.company_id);
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (result) {
                                                ...
                                                $('#sub_location_id').selectpicker('val', html.data.company_id);
                                            }
                                        });
                                    }
                                });
