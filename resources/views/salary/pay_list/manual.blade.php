...
@section('content')
    ...
    <section>
        ...
        <div class="card animated fadeInRight mr-5 ml-5">
            ...
            <div class="card-body">
                <h6><a href="{{url('sample_file/sample_manual.csv')}}" class="btn btn-primary"> <i
                    class="fa fa-download"></i> {{__('Download Sample File')}} </a></h6>
                <form action="{{ route('payroll.manualPost') }}" name="import_manual" id="import_manual" autocomplete="off" enctype="multipart/form-data"
