        ...
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                @if (Auth::user()->role_users_id==1)
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('https://wa.me/919990095122')}}" target="_blank" data-toggle="tooltip"
                           title="{{__('Whatsapp')}}">
    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                @can('view-details-employee')
                    <li class="has-dropdown {{ (request()->is('staff*')) ? 'active' : '' }}">
                        ...
                        <ul id="employees" class="collapse list-unstyled ">
                            @can('view-details-employee')
                                <li id="employee_list"><a href="{{route('employees.index')}}">{{__('Add/Update Employee')}}</a></li>
                            @endcan
                            @can('import-employee')
                    ...
                    <ul id="Organization" class="collapse list-unstyled ">
                         @can('view-client-group')
                                <li id="client_group"><a href="{{route('client_groups.index')}}">{{trans('Client Group')}}</a></li>
                        @endcan
                        @can('view-company')
                        ...
                        @endcan
                        @can('view-sub-location')
                            <li id="sub-location"><a href="{{route('sub-locations.index')}}">Sub Location</a></li>
                        @endcan
                ...
                <li class="has-dropdown {{ (request()->is('templates*')) ? 'active' : '' }}"><a href="#Template_Settings" aria-expanded="false" data-toggle="collapse">
                        <i class="dripicons dripicons-device-desktop"></i><span>{{__('Template Settings')}}</span></a>
                    <ul id="Template_Settings" class="collapse list-unstyled ">
                        
                    <li id="id_template"><a href="{{ route('templates.id-cards.index') }}">{{ __('ID Template') }}</a></li>


                       
                            <li id="offre_template"><a href="">{{__('Offer Letter Template')}}</a></li>
                    ...
                    <li class="has-dropdown {{ (request()->is('payroll*')) ? 'active' : '' }}">
                        ...
                        @if(auth()->user()->can('view-payslip') || auth()->user()->can('view-paylist'))
                            <a href="#Payroll" aria-expanded="false" data-toggle="collapse">
                                <i class="dripicons-wallet"></i><span>{{trans('file.Payment')}}</span>
                            </a>
                        @endif

                        <ul id="Payroll" class="collapse list-unstyled ">
                            @can('view-payslip')
                                <li><a href="{{route('payroll.index')}}">{{__('Generate Payment')}}</a>
                                </li>
                            @endcan
                            @can('view-payslip')
                                <li><a href="{{route('payroll.manual')}}">{{__('Generate Manual Payment')}}</a>
                                </li>
                            @endcan
                            @can('view-paylist')
                    ...
                    <li class="has-dropdown {{ (request()->is('settings*')) ? 'active' : '' }}">
                        @if(auth()->user()->can('view-role')||auth()->user()->can('view-general-setting')||auth()->user()->can('access-language')||auth()->user()->can('access-variable_type')||auth()->user()->can('access-variable_method')||auth()->user()->can('view-general-setting'))
                            <a href="#manageDropdowns" aria-expanded="false" data-toggle="collapse">
                                <i class="dripicons-toggles"></i><span>{{__('Manage Dropdowns')}}</span>
                            </a>
                        @endif
                        {{-- <a href="#manageDropdowns" aria-expanded="false" data-toggle="collapse">
                            <i class="dripicons-toggles"></i><span>{{__('Manage Dropdowns')}}</span>
                        ...
                        <ul id="manageDropdowns" class="collapse list-unstyled ">
                            @can('view-general-setting')
                                <li id="states_settings"><a
                                            href="{{route('states.index')}}">{{__('Add/Update States')}}</a>
                                </li>
                            @endcan
                            @can('access-variable_type')
                                <li id="variable_type"><a
                                            href="{{route('variables.index')}}">{{__('Add/Update Variable Types')}}</a>
                                </li>
                            @endcan
                            @can('access-variable_method')
                                <li id="variable_method"><a
                                            href="{{route('variables_method.index')}}">{{__('Add/Update Variable Methods')}}</a>
                                </li>
                            @endcan
                            @can('view-department')
                                <li id="department"><a
                                            href="{{route('departments.index')}}">{{trans('Add/Update Department')}}</a>
                                </li>
                            @endcan
                            @can('view-designation')
                                <li id="designation"><a
                                            href="{{route('designations.index')}}">{{trans('Add/Update Designation')}}</a>
                                </li>
                            @endcan
                            @can('view-office_shift')
                                <li id="office_shift"><a
                                            href="{{route('office_shift.index')}}">{{__('Add/Update Office Shift')}}</a>
                                </li>
                            @endcan
                            @can('access-variable_type')
                                <li id="salary_components"><a
                                            href="{{route('components.index')}}">{{__('Add/Update Salary Components')}}</a>
                                </li>
                            @endcan
                            @can('view-holiday')
                                <li id="holiday"><a href="{{route('holidays.index')}}">{{__('Add/Update Holiday')}}</a></li>
                            @endcan
                            @can('view-leave')
                                <li id="leave"><a href="{{route('leaves.index')}}">{{__('Add/Update Leaves')}}</a></li>
                            @endcan
                        </ul>
                    </li>
                @endcan
