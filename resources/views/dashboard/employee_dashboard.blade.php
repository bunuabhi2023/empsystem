    ...
    <!-- Content -->
            ...
            <div class="row">
                ...
                <div class="col-9 col-md-10 mb-3">
                    ...
                    <form class="d-inline m1-2" action="{{route('employee_attendance.post',$employee->id)}}" name="set_clocking"
                        ...
                        <input type="hidden" value="" name="in_out_pic" id="in_out_pic">

                        @if(!$employee_attendance || $employee_attendance->clock_in_out== 0)
                            <button class="btn btn-success attendance_btn btn-sm" @if($employee->attendance_type=='ip_based' && $ipCheck!=true) disabled @endif type="button" id="clock_in_btn"><i class="dripicons-enter"></i> {{__('Clock IN')}}</button>
                        @else
                            <button class="btn btn-danger attendance_btn btn-sm" @if($employee->attendance_type=='ip_based' && $ipCheck!=true) disabled @endif type="button" id="clock_out_btn"><i class="dripicons-exit"></i> {{__('Clock OUT')}}</button>
                        @endif
                        {{-- <br> --}}
        ...
        <div id="attendanceModal" class="modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{__('Capture A Selfie')}}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6" align="center">
                            	...
                            	<br>
                            	<button type="button" class="btn btn-success" onclick="saveSnap()">Done</button>
                            </div>
                        <div>
                    </div>
                </div>
        ...
        <script>
        	...
        	function saveSnap(){
        	    $("#in_out_pic").val($("#captured_image_data").val());
