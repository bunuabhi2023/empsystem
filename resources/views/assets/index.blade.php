                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label>{{__('Company Asset Code')}} <span class="text-danger">*</span> </label>
                                <input type="text" name="asset_code" id="asset_code" class="form-control"
                                       placeholder="{{__('Company Asset Code')}}">
                            </div>

                            <div class="col-md-6 form-group">
                                <label>{{trans('file.category')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 form-group">
                                <label>{{__('Is Working')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('file.Employee')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 form-group">
                                <label>{{trans('file.Purchase')}} {{trans('file.Date')}} <span class="text-danger">*</span></label>
                                <input type="text" name="purchase_date" id="purchase_date" required
                                       class="form-control date" autocomplete="off" value="">
                            </div>

                            <div class="col-md-6 form-group">
                                <label>{{trans('file.Warranty/AMC')}} {{__('End Date')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 form-group">
                                <label>{{trans('file.Assets')}} {{__('Image')}} <span class="text-danger">*</span></label>
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    $('#client_grp_id').selectpicker('val', html.data.client_grp_id);
                                    ...
                                    success: function (result) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (result) {
                                                ...
                                                $('#sub_location_id').selectpicker('val', html.data.sub_location_id);
