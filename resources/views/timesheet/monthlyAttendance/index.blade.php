                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-bold">{{trans('From Date')}} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-bold">{{trans('To Date')}} <span class="text-danger">*</span></label>
        ...
        <div class="table-responsive">
            <table id="month_wise_attendance-table" class="table ">
                ...
                <tr>
                    ...
                    <th>{{__('Total Add/Ded')}}</th>
                    <th>{{__('Total Week Off')}}</th>
                    <th>{{__('Total Holiday')}}</th>
                    <th>{{__('Total Absent')}}</th>
                    <th>{{__('Manual Adjustment')}}</th>
                    <th>{{__('Net Payable Days')}}</th>
        ...
        $(document).ready(function() {
            ...
            function fill_datatable(filter_group = '', filter_company = '', filter_loc = '', filter_sub_loc = '', filter_employee = '', filter_month_year = $('#month_year').val(), from_date = $('#from_date').val(), to_date = $('#to_date').val()) {
                ...
                let table_table = $('#month_wise_attendance-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('monthly_attendances.tables') }}",
                        type: "POST",
                        data: {
