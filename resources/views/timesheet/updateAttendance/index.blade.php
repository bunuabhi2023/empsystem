                    ...
                    <div class="modal-body">
                        ...
                        <form autocomplete="off" method="post" id="edit_form" class="form-horizontal" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="manual_adjust"><strong>{{__('Manual Adjustment')}}</strong></label>
                                    <input type="number" name="manual_adjust" id="manual_adjust_edit" class="form-control" value="">
                                </div>
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                success:function(html){
                    ...
                    $('#manual_adjust_edit').val(html.data.adjustment);
